...
/// Global state which helps some sources to figure out the correct feedback.
///
/// See [`MidiSource::feedback_flexible`].
#[derive(Debug, Default)]
pub struct SourceContext {
    pub x_touch_mackie_lcd_state: XTouchMackieLcdState,
}
...
fn get_x_touch_color_index_for_color(color: RgbColor) -> u8 {
    find_closest_color_in_palette(color, &super::devices::x_touch::COLOR_PALETTE)
}
